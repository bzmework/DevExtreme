...
namespace DevExtreme.AspNet.Mvc.Builders
{
	...
	public class ChartExportBuilder : OptionsOwnerBuilder
	{
		[Generated]
		public ChartExportBuilder(OptionsOwnerContext context)
			: base(context)
		{
		}
		...
		[Generated]
		public ChartExportBuilder Option(string jsName, object value)
		{
		...
		[Generated]
		public ChartExportBuilder BackgroundColor(string value)
		{
		...
		/// <summary>Specifies the color that will fill transparent regions in the resulting file or document.</summary>
		[Generated]
		public ChartExportBuilder BackgroundColor(JS value)
		{
			base.Options["backgroundColor"] = value;
			return this;
		}
		...
		[Generated]
		public ChartExportBuilder Enabled(bool value)
		{
		...
		/// <summary>Enables the client-side exporting in the widget.</summary>
		[Generated]
		public ChartExportBuilder Enabled(JS value)
		{
			base.Options["enabled"] = value;
			return this;
		}
		...
		[Generated]
		public ChartExportBuilder FileName(string value)
		{
		...
		/// <summary>Specifies a default name for the file to which the widget will be exported.</summary>
		[Generated]
		public ChartExportBuilder FileName(JS value)
		{
			base.Options["fileName"] = value;
			return this;
		}
		...
		[Generated]
		public ChartExportBuilder Formats(IEnumerable<ExportFormat> value)
		{
		...
		[Generated]
		public ChartExportBuilder Margin(double value)
		{
		...
		/// <summary>Adds an empty space around the exported widget; measured in pixels.</summary>
		[Generated]
		public ChartExportBuilder Margin(JS value)
		{
			base.Options["margin"] = value;
			return this;
		}
		...
		[Generated]
		public ChartExportBuilder PrintingEnabled(bool value)
		{
		...
		/// <summary>Enables the printing feature in the widget. Applies only if the export.enabled option is true.</summary>
		[Generated]
		public ChartExportBuilder PrintingEnabled(JS value)
		{
			base.Options["printingEnabled"] = value;
			return this;
		}
		...
		[Generated]
		public ChartExportBuilder ProxyUrl(string value)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never)]
		[Generated]
		public ChartExportBuilder ProxyUrl(JS value)
		{
			base.Options["proxyUrl"] = value;
			return this;
		}
		...
		[Generated]
		public ChartExportBuilder SvgToCanvas(string jsFunc)
		{
		...
		/// <summary>A function that renders SVG markup on the HTML canvas. Required to export custom SVG elements (for example, markerTemplate).</summary>
		[Generated]
		public ChartExportBuilder SvgToCanvas(RazorBlock jsFunc)
		{
