...
namespace DevExtreme.AspNet.Mvc.Builders
{
	...
	public class PolarChartExportBuilder : OptionsOwnerBuilder
	{
		[Generated]
		public PolarChartExportBuilder(OptionsOwnerContext context)
			: base(context)
		{
		}
		...
		[Generated]
		public PolarChartExportBuilder Option(string jsName, object value)
		{
		...
		[Generated]
		public PolarChartExportBuilder BackgroundColor(string value)
		{
		...
		/// <summary>Specifies the color that will fill transparent regions in the resulting file or document.</summary>
		[Generated]
		public PolarChartExportBuilder BackgroundColor(JS value)
		{
			base.Options["backgroundColor"] = value;
			return this;
		}
		...
		[Generated]
		public PolarChartExportBuilder Enabled(bool value)
		{
		...
		/// <summary>Enables the client-side exporting in the widget.</summary>
		[Generated]
		public PolarChartExportBuilder Enabled(JS value)
		{
			base.Options["enabled"] = value;
			return this;
		}
		...
		[Generated]
		public PolarChartExportBuilder FileName(string value)
		{
		...
		/// <summary>Specifies a default name for the file to which the widget will be exported.</summary>
		[Generated]
		public PolarChartExportBuilder FileName(JS value)
		{
			base.Options["fileName"] = value;
			return this;
		}
		...
		[Generated]
		public PolarChartExportBuilder Formats(IEnumerable<ExportFormat> value)
		{
		...
		[Generated]
		public PolarChartExportBuilder Margin(double value)
		{
		...
		/// <summary>Adds an empty space around the exported widget; measured in pixels.</summary>
		[Generated]
		public PolarChartExportBuilder Margin(JS value)
		{
			base.Options["margin"] = value;
			return this;
		}
		...
		[Generated]
		public PolarChartExportBuilder PrintingEnabled(bool value)
		{
		...
		/// <summary>Enables the printing feature in the widget. Applies only if the export.enabled option is true.</summary>
		[Generated]
		public PolarChartExportBuilder PrintingEnabled(JS value)
		{
			base.Options["printingEnabled"] = value;
			return this;
		}
		...
		[Generated]
		public PolarChartExportBuilder ProxyUrl(string value)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never)]
		[Generated]
		public PolarChartExportBuilder ProxyUrl(JS value)
		{
			base.Options["proxyUrl"] = value;
			return this;
		}
		...
		[Generated]
		public PolarChartExportBuilder SvgToCanvas(string jsFunc)
		{
		...
		/// <summary>A function that renders SVG markup on the HTML canvas. Required to export custom SVG elements (for example, markerTemplate).</summary>
		[Generated]
		public PolarChartExportBuilder SvgToCanvas(RazorBlock jsFunc)
		{
